...
const gameValidator_1 = require("../src/middleware/gameValidator");
...
describe('Middleware validateCreateGame', () => {
    it('restituisce 400 se il campo "vs" non è né "PVP" né "PVE"', () => {
        ...
        (0, gameValidator_1.validateCreateGame)(req, res, next);
        //asserzioni
        expect(res.status).toHaveBeenCalledWith(Status_codes_1.StatusCodes.BAD_REQUEST); // abbia risposto con il codice BAD_REQUEST
