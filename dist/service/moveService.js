...
exports.MoveService = exports.HitResult = void 0;
var HitResult;
(function (HitResult) {
    HitResult["HIT"] = "HIT";
    HitResult["WATER"] = "WATER";
    HitResult["SUNK"] = "SUNK";
})(HitResult || (exports.HitResult = HitResult = {}));
class MoveService {
    ...
    async doYourMove(gameId, playerId, x, y) {
    ...
    async validateCoordinates(grid, x, y) {
    ...
    //crea la mossa
    async recordMove(gameId, playerId, x, y, result) {
    ...
    async reducePlayerToken(playerId) {
